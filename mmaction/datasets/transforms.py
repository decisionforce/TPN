...
class RandomResizedCrop(object):
    """Crop the given list of PIL Image to random size and aspect ratio.
...
class GroupImageTransform(object):
    ...
    def __init__(self,
        ...
        self.colorjitter = GroupColorJitter(color_space_aug=color_space_aug) if colorjitter else None
    ...
    def __call__(self, img_group, scale, crop_history=None, flip=False,
        ...
        return img_group, img_shape, img_shape, scale_factor, crop_quadruple
